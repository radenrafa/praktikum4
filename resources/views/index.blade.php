              ...
              <div class="card-body p-4">
                <div class="row d-flex justify-content-between align-items-center">
                  <div class="col-md-2 col-lg-2 col-xl-2">
                    <img src="C:\laragon\www\praktikum4\public\Screenshot 2023-10-18 101424.png" alt="Asus ROG" class="img-fluid rounded-3">
                  </div>
                  <div class="col-md-3 col-lg-3 col-xl-3">
                    <p class="lead fw-normal mb-2">ASUS ROG Zephyrus G16 GU603ZU-I745J6G-O</p>
                  ...
                  <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                    <h5 class="mb-0">Rp. 27.999.000</h5>
                  </div>
